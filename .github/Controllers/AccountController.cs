...
namespace VWA_TFE.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, MailSettings mailSettings, RoleManager<IdentityRole> roleManager)
        {
